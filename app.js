...
function checkAnswer() {
    ...
    if (penaltyCount >= 5) {
        showModal(`You Lose! ⚠ Too many incorrect answers.<br>The correct answer was: <h3>${currentRiddle.answer}</h3>`);
        resetGame();
    } else {
...
function showModal(message) {
    ...
    modalMessage.innerHTML = message; // Ensure innerHTML is used
